...
class  HospitalmanagementsystemApplicationTests {
	...
	public void PatientSignUp() {
		PatientSignUp patientsignup = patientsignupRepository.findById(71).get();
		assertEquals(71,patientsignup.getP_id());
	}
	...
	public void addDoctorSignUp() {
		...
		assertNotNull(doctorsignupRepository.findById(169).get());
	}
	...
	public void DoctorSignUp() {
		Doctor doctorsignup = doctorsignupRepository.findById(169).get();
		assertEquals(169, doctorsignup.getD_id());
	}
	...
	public void addAppointment() {
		...
		assertNotNull(appointmentRepository.findById(57).get());
	...
	public void Appointment() {
		Appointment appointment = appointmentRepository.findById(57).get();
		assertEquals(57, appointment.getAp_id());
	}
	...
	public void addDischarge() {
		...
		assertNotNull(dischargedpatientRepository.findById(100).get());
	}
